    ...
    <section className="py-20">
      <div className="container px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="mt-4 text-lg text-slate-300">Monitor crop health, get NDVI insights and alerts, and make faster farm decisions with high-resolution satellite analytics.</p>
        ...
        <div>
          <Card className="p-0 overflow-hidden">
            <div className="h-72 bg-gradient-to-br from-emerald-500/20 to-green-400/10 flex items-center justify-center">
              <div className="text-slate-200">[Map preview]</div>
            </div>
          </Card>
        </div>
      </div>
