 ...
 */
export function assembleInference(status, category, input) {
 ...
 */
function computeConfidence(status, input) {
    let confidence = 0;
 ...
 */
function generateExplanation(status, category, input, confidence) {
    const parts = [];
    // Current condition
